...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	function ContentTypesContainer() {
	  return _react2.default.createElement(
	    'p',
	    null,
	    'I contain'
	...
	var SettingsContainer = (0, _react.createClass)({
	  contextTypes: {
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    _reactRouter.Route,
	    { path: '/', component: App },
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: SettingsContainer }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'entries/by-content-type', component: ContentTypesContainer })
	  )
	...
	*/
	...
	function initializeClient(credentials, next, replace) {
	  initClient(credentials.space, credentials.accessToken).then(function () {
	    return next();
	  }, function (err) {
	    replace({
	      pathname: '/error',
